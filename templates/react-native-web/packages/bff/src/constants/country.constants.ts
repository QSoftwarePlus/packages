export const countryAndStates = [
  ...
  { code: 'ALA', name: 'Aland Islands', states: [] },
  {
    ...
    states: [
      ...
      { id: 607, name: 'Bulqizë District', code: 'BU' },
      { id: 618, name: 'Delvinë District', code: 'DL' },
      { id: 608, name: 'Devoll District', code: 'DV' },
      { id: 610, name: 'Dibër County', code: '09' },
      { id: 605, name: 'Dibër District', code: 'DI' },
      { id: 632, name: 'Durrës County', code: '02' },
      { id: 639, name: 'Durrës District', code: 'DR' },
      { id: 598, name: 'Elbasan County', code: '03' },
      { id: 631, name: 'Fier County', code: '04' },
      { id: 627, name: 'Fier District', code: 'FR' },
      { id: 604, name: 'Gjirokastër County', code: '05' },
      { id: 621, name: 'Gjirokastër District', code: 'GJ' },
      { id: 617, name: 'Gramsh District', code: 'GR' },
      { id: 600, name: 'Has District', code: 'HA' },
      { id: 594, name: 'Kavajë District', code: 'KA' },
      { id: 628, name: 'Kolonjë District', code: 'ER' },
      { id: 630, name: 'Korçë County', code: '06' },
      { id: 597, name: 'Korçë District', code: 'KO' },
      { id: 614, name: 'Krujë District', code: 'KR' },
      { id: 612, name: 'Kuçovë District', code: 'KC' },
      { id: 601, name: 'Kukës County', code: '07' },
      { id: 623, name: 'Kukës District', code: 'KU' },
      { id: 622, name: 'Kurbin District', code: 'KB' },
      { id: 609, name: 'Lezhë County', code: '08' },
      { id: 595, name: 'Lezhë District', code: 'LE' },
      { id: 596, name: 'Librazhd District', code: 'LB' },
      { id: 599, name: 'Lushnjë District', code: 'LU' },
      { id: 602, name: 'Malësi e Madhe District', code: 'MM' },
      { id: 637, name: 'Mallakastër District', code: 'MK' },
      { id: 635, name: 'Mat District', code: 'MT' },
      { id: 638, name: 'Mirditë District', code: 'MR' },
      { id: 619, name: 'Peqin District', code: 'PQ' },
      { id: 625, name: 'Përmet District', code: 'PR' },
      { id: 606, name: 'Pogradec District', code: 'PG' },
      { id: 620, name: 'Pukë District', code: 'PU' },
      { id: 624, name: 'Sarandë District', code: 'SR' },
      { id: 611, name: 'Shkodër County', code: '10' },
      { id: 626, name: 'Shkodër District', code: 'SH' },
      { id: 593, name: 'Skrapar District', code: 'SK' },
      { id: 616, name: 'Tepelenë District', code: 'TE' },
      { id: 615, name: 'Tirana County', code: '11' },
      { id: 633, name: 'Tirana District', code: 'TR' },
      { id: 636, name: 'Tropojë District', code: 'TP' },
      { id: 634, name: 'Vlorë County', code: '12' },
      { id: 613, name: 'Vlorë District', code: 'VL' },
    ],
  },
  {
    code: 'DZA',
    ...
    states: [
      ...
      { id: 1119, name: 'Aïn Defla', code: '44' },
      { id: 1122, name: 'Aïn Témouchent', code: '46' },
      { id: 1144, name: 'Algiers', code: '16' },
      { id: 1103, name: 'Annaba', code: '23' },
      { id: 1142, name: 'Batna', code: '05' },
      { id: 1108, name: 'Béchar', code: '08' },
      { id: 1128, name: 'Béjaïa', code: '06' },
      { id: 4909, name: 'Béni Abbès', code: '53' },
      { id: 1114, name: 'Biskra', code: '07' },
      { id: 1111, name: 'Blida', code: '09' },
      { id: 4908, name: 'Bordj Baji Mokhtar', code: '52' },
      { id: 1116, name: 'Bordj Bou Arréridj', code: '34' },
      { id: 1104, name: 'Bouïra', code: '10' },
      { id: 1125, name: 'Boumerdès', code: '35' },
      ...
      { id: 1123, name: 'Saïda', code: '20' },
      { id: 1141, name: 'Sétif', code: '19' },
      { id: 4902, name: 'Sidi Bel Abbès', code: '22' },
      { id: 1110, name: 'Skikda', code: '21' },
      { id: 1143, name: 'Souk Ahras', code: '41' },
      { id: 1135, name: 'Tamanghasset', code: '11' },
      { id: 1117, name: 'Tébessa', code: '12' },
  ...
  { code: 'ASM', name: 'American Samoa', states: [] },
  {
    ...
    states: [
      ...
      { id: 490, name: 'Sant Julià de Lòria', code: '06' },
    ],
  },
  {
    code: 'AGO',
    ...
    states: [
      ...
      { id: 212, name: 'Bié Province', code: 'BIE' },
      ...
      { id: 225, name: 'Huíla Province', code: 'HUI' },
      ...
      { id: 224, name: 'Uíge Province', code: 'UIG' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4880, name: 'Ciudad Autónoma de Buenos Aires', code: 'C' },
      { id: 3642, name: 'Córdoba', code: 'X' },
      { id: 3638, name: 'Corrientes', code: 'W' },
      { id: 3654, name: 'Entre Ríos', code: 'E' },
      ...
      { id: 3648, name: 'Neuquén', code: 'Q' },
      { id: 3639, name: 'Río Negro', code: 'R' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3080, name: 'Ouémé Department', code: 'OU' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3383, name: 'Potosí Department', code: 'P' },
  ...
  },
  {
    ...
    name: 'Burkina Faso',
    states: [
      { id: 3160, name: 'Balé Province', code: 'BAL' },
      { id: 3155, name: 'Bam Province', code: 'BAM' },
      { id: 3120, name: 'Banwa Province', code: 'BAN' },
      { id: 3152, name: 'Bazèga Province', code: 'BAZ' },
      ...
      { id: 3167, name: 'Comoé Province', code: 'COM' },
      ...
      { id: 3112, name: 'Kénédougou Province', code: 'KEN' },
      { id: 3132, name: 'Komondjari Province', code: 'KMD' },
      { id: 3157, name: 'Kompienga Province', code: 'KMP' },
      { id: 3146, name: 'Kossi Province', code: 'KOS' },
      { id: 3133, name: 'Koulpélogo Province', code: 'KOP' },
      { id: 3161, name: 'Kouritenga Province', code: 'KOT' },
      { id: 3147, name: 'Kourwéogo Province', code: 'KOW' },
      { id: 3159, name: 'Léraba Province', code: 'LER' },
      ...
      { id: 3118, name: 'Zoundwéogo Province', code: 'ZOU' },
    ],
  },
  {
    code: 'BDI',
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2986, name: 'São Domingos', code: 'SD' },
      { id: 3000, name: 'São Filipe', code: 'SF' },
      { id: 2993, name: 'São Lourenço dos Órgãos', code: 'SO' },
      { id: 2990, name: 'São Miguel', code: 'SM' },
      { id: 3001, name: 'São Vicente', code: 'SV' },
      { id: 2992, name: 'Sotavento Islands', code: 'S' },
      { id: 2983, name: 'Tarrafal', code: 'TA' },
      { id: 3003, name: 'Tarrafal de São Nicolau', code: 'TS' },
    ],
  },
  { code: 'CYM', name: 'Cayman Islands', states: [] },
  {
    ...
    states: [
      ...
      { id: 1263, name: 'Kémo Prefecture', code: 'KG' },
      { id: 1256, name: 'Lobaye Prefecture', code: 'LB' },
      { id: 1257, name: 'Mambéré-Kadéï', code: 'HS' },
      { id: 1266, name: 'Mbomou Prefecture', code: 'MB' },
      { id: 1253, name: 'Nana-Grébizi Economic Prefecture', code: 'KB' },
      { id: 1260, name: 'Nana-Mambéré Prefecture', code: 'NM' },
      { id: 1255, name: "Ombella-M'Poko Prefecture", code: 'MP' },
      { id: 1265, name: 'Ouaka Prefecture', code: 'UK' },
      { id: 1254, name: 'Ouham Prefecture', code: 'AC' },
      { id: 1267, name: 'Ouham-Pendé Prefecture', code: 'OP' },
      { id: 1252, name: 'Sangha-Mbaéré', code: 'SE' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3582, name: 'Ouaddaï', code: 'OD' },
      { id: 3592, name: 'Salamat', code: 'SA' },
      { id: 3572, name: 'Sila', code: 'SI' },
      { id: 3579, name: 'Tandjilé', code: 'TA' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2827, name: 'Biobío', code: 'BI' },
      { id: 2825, name: 'Coquimbo', code: 'CO' },
      { id: 2826, name: 'La Araucanía', code: 'AR' },
      {
        id: 2838,
      ...
      { id: 2831, name: 'Ñuble', code: 'NB' },
      { id: 2824, name: 'Región Metropolitana de Santiago', code: 'RM' },
      { id: 2837, name: 'Tarapacá', code: 'TA' },
      { id: 2830, name: 'Valparaíso', code: 'VS' },
    ],
  },
  {
    code: 'CHN',
  ...
  { code: 'CCK', name: 'Cocos (Keeling) Islands', states: [] },
  {
    ...
    states: [
      ...
      { id: 2880, name: 'Atlántico', code: 'ATL' },
      { id: 4921, name: 'Bogotá D.C.', code: 'DC' },
      { id: 2893, name: 'Bolívar', code: 'BOL' },
      { id: 2903, name: 'Boyacá', code: 'BOY' },
      { id: 2887, name: 'Caldas', code: 'CAL' },
      { id: 2891, name: 'Caquetá', code: 'CAQ' },
      { id: 2892, name: 'Casanare', code: 'CAS' },
      { id: 2884, name: 'Cauca', code: 'CAU' },
      { id: 2899, name: 'Cesar', code: 'CES' },
      { id: 2876, name: 'Chocó', code: 'CHO' },
      { id: 2898, name: 'Córdoba', code: 'COR' },
      { id: 2875, name: 'Cundinamarca', code: 'CUN' },
      { id: 2882, name: 'Guainía', code: 'GUA' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2868, name: 'Lékoumou Department', code: '2' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2631, name: 'Marahoué Region', code: '12' },
      { id: 2629, name: 'Montagnes District', code: 'MG' },
      { id: 2646, name: 'Moyen-Cavally', code: '19' },
      { id: 2630, name: 'Moyen-Comoé', code: '05' },
      { id: 2655, name: "N'zi-Comoé", code: '11' },
      { id: 2648, name: 'Sassandra-Marahoué District', code: 'SM' },
      { id: 2625, name: 'Savanes Region', code: '03' },
      { id: 2628, name: 'Sud-Bandama', code: '15' },
      { id: 2652, name: 'Sud-Comoé', code: '13' },
      { id: 2637, name: 'Vallée du Bandama District', code: 'VB' },
      { id: 2647, name: 'Vallée du Bandama Region', code: '04' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 286, name: 'Camagüey Province', code: '09' },
      { id: 282, name: 'Ciego de Ávila Province', code: '08' },
      { id: 287, name: 'Cienfuegos Province', code: '06' },
      { id: 275, name: 'Granma Province', code: '12' },
      { id: 285, name: 'Guantánamo Province', code: '14' },
      { id: 272, name: 'Havana Province', code: '03' },
      { id: 279, name: 'Holguín Province', code: '11' },
      ...
      { id: 277, name: 'Pinar del Río Province', code: '01' },
      { id: 274, name: 'Sancti Spíritus Province', code: '07' },
      { id: 273, name: 'Santiago de Cuba Province', code: '13' },
      { id: 280, name: 'Villa Clara Province', code: '05' },
    ],
  },
  { code: 'CUW', name: 'Curaçao', states: [] },
  {
    code: 'CYP',
    name: 'Cyprus',
    states: [
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4644, name: 'Bruntál', code: '801' },
      { id: 4633, name: 'Česká Lípa', code: '511' },
      { id: 4556, name: 'České Budějovice', code: '311' },
      { id: 4543, name: 'Český Krumlov', code: '312' },
      { id: 4573, name: 'Cheb', code: '411' },
      { id: 4553, name: 'Chomutov', code: '422' },
      { id: 4634, name: 'Chrudim', code: '531' },
      { id: 4609, name: 'Děčín', code: '421' },
      { id: 4641, name: 'Domažlice', code: '321' },
      { id: 4559, name: 'Frýdek-Místek', code: '802' },
      { id: 4611, name: 'Havlíčkův Brod', code: '631' },
      { id: 4561, name: 'Hodonín', code: '645' },
      { id: 4580, name: 'Hradec Králové', code: '521' },
      { id: 4612, name: 'Jablonec nad Nisou', code: '512' },
      { id: 4625, name: 'Jeseník', code: '711' },
      { id: 4640, name: 'Jičín', code: '522' },
      { id: 4613, name: 'Jihlava', code: '632' },
      { id: 4639, name: 'Jihočeský kraj', code: '31' },
      { id: 4602, name: 'Jihomoravský kraj', code: '64' },
      { id: 4624, name: 'Jindřichův Hradec', code: '313' },
      { id: 4581, name: 'Karlovarský kraj', code: '41' },
      { id: 4604, name: 'Karlovy Vary', code: '412' },
      { id: 4586, name: 'Karviná', code: '803' },
      { id: 4631, name: 'Kladno', code: '203' },
      { id: 4591, name: 'Klatovy', code: '322' },
      { id: 4618, name: 'Kolín', code: '204' },
      { id: 4575, name: 'Kraj Vysočina', code: '63' },
      { id: 4614, name: 'Královéhradecký kraj', code: '52' },
      { id: 4593, name: 'Kroměříž', code: '721' },
      { id: 4923, name: 'Kutná Hora', code: '205' },
      { id: 4590, name: 'Liberec', code: '513' },
      { id: 4601, name: 'Liberecký kraj', code: '51' },
      { id: 4605, name: 'Litoměřice', code: '423' },
      { id: 4617, name: 'Louny', code: '424' },
      { id: 4638, name: 'Mělník', code: '206' },
      { id: 4643, name: 'Mladá Boleslav', code: '207' },
      { id: 4600, name: 'Moravskoslezský kraj', code: '80' },
      { id: 4629, name: 'Most', code: '425' },
      { id: 4550, name: 'Náchod', code: '523' },
      { id: 4548, name: 'Nový Jičín', code: '804' },
      { id: 4582, name: 'Nymburk', code: '208' },
      { id: 4574, name: 'Olomouc', code: '712' },
      { id: 4589, name: 'Olomoucký kraj', code: '71' },
      { id: 4623, name: 'Opava', code: '805' },
      { id: 4584, name: 'Ostrava-město', code: '806' },
      { id: 4547, name: 'Pardubice', code: '532' },
      { id: 4588, name: 'Pardubický kraj', code: '53' },
      { id: 4645, name: 'Pelhřimov', code: '633' },
      { id: 4560, name: 'Písek', code: '314' },
      { id: 4608, name: 'Plzeň-jih', code: '324' },
      { id: 4544, name: 'Plzeň-město', code: '323' },
      { id: 4564, name: 'Plzeň-sever', code: '325' },
      { id: 4607, name: 'Plzeňský kraj', code: '32' },
      { id: 4578, name: 'Prachatice', code: '315' },
      { id: 4606, name: 'Praha-východ', code: '209' },
      { id: 4619, name: 'Praha-západ', code: '20A' },
      { id: 4598, name: 'Praha, Hlavní město', code: '10' },
      { id: 4626, name: 'Přerov', code: '714' },
      { id: 4546, name: 'Příbram', code: '20B' },
      { id: 4551, name: 'Prostějov', code: '713' },
      { id: 4558, name: 'Rakovník', code: '20C' },
      ...
      { id: 4554, name: 'Středočeský kraj', code: '20' },
      { id: 4642, name: 'Šumperk', code: '715' },
      { id: 4571, name: 'Svitavy', code: '533' },
      { id: 4565, name: 'Tábor', code: '317' },
      { id: 4646, name: 'Tachov', code: '327' },
      { id: 4621, name: 'Teplice', code: '426' },
      { id: 4597, name: 'Třebíč', code: '634' },
      { id: 4579, name: 'Trutnov', code: '525' },
      { id: 4592, name: 'Uherské Hradiště', code: '722' },
      { id: 4576, name: 'Ústecký kraj', code: '42' },
      { id: 4599, name: 'Ústí nad Labem', code: '427' },
      { id: 4647, name: 'Ústí nad Orlicí', code: '534' },
      { id: 4572, name: 'Vsetín', code: '723' },
      { id: 4622, name: 'Vyškov', code: '646' },
      { id: 4648, name: 'Žďár nad Sázavou', code: '635' },
      { id: 4563, name: 'Zlín', code: '724' },
      { id: 4552, name: 'Zlínský kraj', code: '72' },
  ...
  },
  {
    ...
    states: [
      { id: 2753, name: 'Bas-Uélé', code: 'BU' },
      { id: 2744, name: 'Équateur', code: 'EQ' },
      { id: 2750, name: 'Haut-Katanga', code: 'HK' },
      { id: 2758, name: 'Haut-Lomami', code: 'HL' },
      { id: 2734, name: 'Haut-Uélé', code: 'HU' },
      { id: 2751, name: 'Ituri', code: 'IT' },
      { id: 2757, name: 'Kasaï', code: 'KS' },
      { id: 2742, name: 'Kasaï Central', code: 'KC' },
      { id: 2735, name: 'Kasaï Oriental', code: 'KE' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4107, name: 'Dajabón Province', code: '05' },
      ...
      { id: 4094, name: 'María Trinidad Sánchez Province', code: '14' },
      { id: 4099, name: 'Monseñor Nouel Province', code: '28' },
      ...
      { id: 4103, name: 'Samaná Province', code: '20' },
      { id: 4091, name: 'San Cristóbal Province', code: '21' },
      { id: 4112, name: 'San José de Ocoa Province', code: '31' },
      { id: 4098, name: 'San Juan Province', code: '22' },
      { id: 4110, name: 'San Pedro de Macorís', code: '23' },
      { id: 4088, name: 'Sánchez Ramírez Province', code: '24' },
      { id: 4108, name: 'Santiago Province', code: '25' },
      { id: 4100, name: 'Santiago Rodríguez Province', code: '26' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4523, name: 'Lautém Municipality', code: 'LA' },
      { id: 4515, name: 'Liquiçá Municipality', code: 'LI' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2920, name: 'Bolívar', code: 'B' },
      { id: 2917, name: 'Cañar', code: 'F' },
      ...
      { id: 2905, name: 'Galápagos', code: 'W' },
      { id: 2914, name: 'Guayas', code: 'G' },
      { id: 2911, name: 'Imbabura', code: 'I' },
      { id: 5068, name: 'Loja', code: 'L' },
      { id: 2910, name: 'Los Ríos', code: 'R' },
      { id: 2913, name: 'Manabí', code: 'M' },
      ...
      { id: 2919, name: 'Santo Domingo de los Tsáchilas', code: 'SD' },
      { id: 2906, name: 'Sucumbíos', code: 'U' },
  ...
  },
  {
    ...
    name: 'El Salvador',
    states: [
      { id: 4139, name: 'Ahuachapán Department', code: 'AH' },
      { id: 4132, name: 'Cabañas Department', code: 'CA' },
      { id: 4131, name: 'Chalatenango Department', code: 'CH' },
      { id: 4137, name: 'Cuscatlán Department', code: 'CU' },
      { id: 4134, name: 'La Libertad Department', code: 'LI' },
      { id: 4136, name: 'La Paz Department', code: 'PA' },
      { id: 4138, name: 'La Unión Department', code: 'UN' },
      { id: 4130, name: 'Morazán Department', code: 'MO' },
      ...
      { id: 4129, name: 'Usulután Department', code: 'US' },
    ],
  },
  {
    code: 'GNQ',
    ...
    states: [
      { id: 3444, name: 'Annobón Province', code: 'AN' },
      ...
      { id: 3439, name: 'Kié-Ntem Province', code: 'KN' },
      { id: 3441, name: 'Litoral Province', code: 'LI' },
      { id: 3438, name: 'Río Muni', code: 'C' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3566, name: 'Järva County', code: '51' },
      { id: 3565, name: 'Jõgeva County', code: '49' },
      { id: 3568, name: 'Lääne County', code: '57' },
      { id: 3564, name: 'Lääne-Viru County', code: '59' },
      { id: 3562, name: 'Pärnu County', code: '67' },
      { id: 3563, name: 'Põlva County', code: '65' },
      ...
      { id: 3560, name: 'Võru County', code: '86' },
    ],
  },
  {
    code: 'ETH',
  ...
  },
  {
    ...
    name: 'Finland',
    states: [
      { id: 1509, name: 'Åland Islands', code: '01' },
      ...
      { id: 1502, name: 'Päijänne Tavastia', code: '16' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4973, name: 'Ardèche', code: '07' },
      { id: 4974, name: 'Ardennes', code: '08' },
      { id: 4975, name: 'Ariège', code: '09' },
      { id: 4976, name: 'Aube', code: '10' },
      { id: 4977, name: 'Aude', code: '11' },
      { id: 4798, name: 'Auvergne-Rhône-Alpes', code: 'ARA' },
      { id: 4978, name: 'Aveyron', code: '12' },
      { id: 5035, name: 'Bas-Rhin', code: '67' },
      { id: 4979, name: 'Bouches-du-Rhône', code: '13' },
      { id: 4825, name: 'Bourgogne-Franche-Comté', code: 'BFC' },
      ...
      { id: 5038, name: 'Métropole de Lyon', code: '69M' },
      ...
      { id: 4812, name: 'Provence-Alpes-Côte-d’Azur', code: 'PAC' },
      { id: 5031, name: 'Puy-de-Dôme', code: '63' },
      { id: 5032, name: 'Pyrénées-Atlantiques', code: '64' },
      { id: 5034, name: 'Pyrénées-Orientales', code: '66' },
      { id: 5037, name: 'Rhône', code: '69' },
      { id: 4821, name: 'Saint Pierre and Miquelon', code: 'PM' },
      { id: 4794, name: 'Saint-Barthélemy', code: 'BL' },
      { id: 4809, name: 'Saint-Martin', code: 'MF' },
      { id: 5040, name: 'Saône-et-Loire', code: '71' },
  ...
  { code: 'ATF', name: 'French Southern Territories', states: [] },
  {
    ...
    states: [
      ...
      { id: 2726, name: 'Haut-Ogooué Province', code: '2' },
      { id: 2730, name: 'Moyen-Ogooué Province', code: '3' },
      { id: 2731, name: 'Ngounié Province', code: '4' },
      { id: 2725, name: 'Nyanga Province', code: '5' },
      { id: 2724, name: 'Ogooué-Ivindo Province', code: '6' },
      { id: 2729, name: 'Ogooué-Lolo Province', code: '7' },
      { id: 2728, name: 'Ogooué-Maritime Province', code: '8' },
  ...
  },
  {
    ...
    name: 'Germany',
    states: [
      { id: 3006, name: 'Baden-Württemberg', code: 'BW' },
  ...
  { code: 'GUM', name: 'Guam', states: [] },
  {
    ...
    states: [
      ...
      { id: 3669, name: 'Petén Department', code: 'PE' },
      { id: 3668, name: 'Quetzaltenango Department', code: 'QZ' },
      { id: 3657, name: 'Quiché Department', code: 'QC' },
      { id: 3664, name: 'Retalhuleu Department', code: 'RE' },
      { id: 3676, name: 'Sacatepéquez Department', code: 'SA' },
      { id: 3667, name: 'San Marcos Department', code: 'SM' },
      { id: 3665, name: 'Santa Rosa Department', code: 'SR' },
      { id: 3661, name: 'Sololá Department', code: 'SO' },
      { id: 3660, name: 'Suchitepéquez Department', code: 'SU' },
      { id: 3663, name: 'Totonicapán Department', code: 'TO' },
    ],
  },
  { code: 'GGY', name: 'Guernsey and Alderney', states: [] },
  {
    ...
    states: [
      ...
      { id: 2709, name: 'Boké Prefecture', code: 'BK' },
      { id: 2676, name: 'Boké Region', code: 'B' },
      ...
      { id: 2680, name: 'Labé Prefecture', code: 'LA' },
      { id: 2677, name: 'Labé Region', code: 'L' },
      { id: 2690, name: 'Lélouma Prefecture', code: 'LE' },
      ...
      { id: 2678, name: 'Nzérékoré Prefecture', code: 'NZ' },
      { id: 2684, name: 'Nzérékoré Region', code: 'N' },
      { id: 2694, name: 'Pita Prefecture', code: 'PI' },
      { id: 2707, name: 'Siguiri Prefecture', code: 'SI' },
      { id: 2687, name: 'Télimélé Prefecture', code: 'TE' },
      { id: 2696, name: 'Tougué Prefecture', code: 'TO' },
  ...
  { code: 'HMD', name: 'Heard Island and McDonald Islands', states: [] },
  {
    ...
    name: 'Honduras',
    states: [
      { id: 4047, name: 'Atlántida Department', code: 'AT' },
      { id: 4045, name: 'Bay Islands Department', code: 'IB' },
      { id: 4041, name: 'Choluteca Department', code: 'CH' },
      { id: 4051, name: 'Colón Department', code: 'CL' },
      { id: 4042, name: 'Comayagua Department', code: 'CM' },
      { id: 4049, name: 'Copán Department', code: 'CP' },
      { id: 4046, name: 'Cortés Department', code: 'CR' },
      { id: 4043, name: 'El Paraíso Department', code: 'EP' },
      { id: 4052, name: 'Francisco Morazán Department', code: 'FM' },
      { id: 4048, name: 'Gracias a Dios Department', code: 'GD' },
      { id: 4044, name: 'Intibucá Department', code: 'IN' },
      ...
      { id: 4053, name: 'Santa Bárbara Department', code: 'SB' },
  ...
  },
  {
    ...
    name: 'Hungary',
    states: [
      { id: 1048, name: 'Bács-Kiskun', code: 'BK' },
      { id: 1055, name: 'Baranya', code: 'BA' },
      { id: 1060, name: 'Békés', code: 'BE' },
      { id: 1036, name: 'Békéscsaba', code: 'BC' },
      { id: 1058, name: 'Borsod-Abaúj-Zemplén', code: 'BZ' },
      { id: 1064, name: 'Budapest', code: 'BU' },
      { id: 1031, name: 'Csongrád County', code: 'CS' },
      { id: 1032, name: 'Debrecen', code: 'DE' },
      { id: 1049, name: 'Dunaújváros', code: 'DU' },
      { id: 1037, name: 'Eger', code: 'EG' },
      { id: 1028, name: 'Érd', code: 'ER' },
      { id: 1044, name: 'Fejér County', code: 'FE' },
      { id: 1041, name: 'Győr', code: 'GY' },
      { id: 1042, name: 'Győr-Moson-Sopron County', code: 'GS' },
      { id: 1063, name: 'Hajdú-Bihar County', code: 'HB' },
      { id: 1040, name: 'Heves County', code: 'HE' },
      { id: 1027, name: 'Hódmezővásárhely', code: 'HV' },
      { id: 1043, name: 'Jász-Nagykun-Szolnok County', code: 'JN' },
      { id: 1067, name: 'Kaposvár', code: 'KV' },
      { id: 1056, name: 'Kecskemét', code: 'KM' },
      { id: 5085, name: 'Komárom-Esztergom', code: 'KE' },
      { id: 1065, name: 'Miskolc', code: 'MI' },
      { id: 1030, name: 'Nagykanizsa', code: 'NK' },
      { id: 1051, name: 'Nógrád County', code: 'NO' },
      { id: 1034, name: 'Nyíregyháza', code: 'NY' },
      { id: 1053, name: 'Pécs', code: 'PS' },
      { id: 1059, name: 'Pest County', code: 'PE' },
      { id: 1068, name: 'Salgótarján', code: 'ST' },
      { id: 1035, name: 'Somogy County', code: 'SO' },
      { id: 1057, name: 'Sopron', code: 'SN' },
      { id: 1045, name: 'Szabolcs-Szatmár-Bereg County', code: 'SZ' },
      { id: 1029, name: 'Szeged', code: 'SD' },
      { id: 1033, name: 'Székesfehérvár', code: 'SF' },
      { id: 1061, name: 'Szekszárd', code: 'SS' },
      { id: 1047, name: 'Szolnok', code: 'SK' },
      { id: 1052, name: 'Szombathely', code: 'SH' },
      { id: 1066, name: 'Tatabánya', code: 'TB' },
      { id: 1038, name: 'Tolna County', code: 'TO' },
      { id: 1039, name: 'Vas County', code: 'VA' },
      { id: 1062, name: 'Veszprém', code: 'VM' },
      { id: 1054, name: 'Veszprém County', code: 'VE' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 1779, name: 'Forlì-Cesena', code: 'FC' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 1000, name: 'Jalal-Abad Region', code: 'J' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 251, name: 'Ménaka Region', code: '9' },
      { id: 255, name: 'Mopti Region', code: '5' },
      { id: 249, name: 'Ségou Region', code: '4' },
      { id: 254, name: 'Sikasso Region', code: '3' },
      { id: 256, name: 'Taoudénit Region', code: '10' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3261, name: 'Rivière du Rempart', code: 'RR' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 4382, name: 'Hîncești District', code: 'HI' },
      ...
      { id: 4376, name: 'Rîșcani District', code: 'RI' },
      { id: 4364, name: 'Sîngerei District', code: 'SI' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 1969, name: 'Bayan-Ölgii Province', code: '071' },
      ...
      { id: 1978, name: 'Govisümber Province', code: '064' },
      { id: 1974, name: 'Khentii Province', code: '039' },
      { id: 1964, name: 'Khovd Province', code: '043' },
      { id: 1975, name: 'Khövsgöl Province', code: '041' },
      { id: 1967, name: 'Ömnögovi Province', code: '053' },
      { id: 1966, name: 'Orkhon Province', code: '035' },
      { id: 1965, name: 'Övörkhangai Province', code: '055' },
      { id: 1980, name: 'Selenge Province', code: '049' },
      { id: 1977, name: 'Sükhbaatar Province', code: '051' },
      { id: 1968, name: 'Töv Province', code: '047' },
  ...
  { code: 'MSR', name: 'Montserrat', states: [] },
  {
    ...
    states: [
      ...
      { id: 3267, name: 'Al Hoceïma', code: 'HOC' },
      { id: 3266, name: 'Aousserd (EH)', code: 'AOU' },
      { id: 3297, name: 'Assa-Zag (EH-partial)', code: 'ASZ' },
      { id: 3321, name: 'Azilal', code: 'AZI' },
      { id: 3272, name: 'Béni Mellal', code: 'BEM' },
      { id: 3278, name: 'Béni Mellal-Khénifra', code: '05' },
      ...
      { id: 4932, name: 'Fès', code: 'FES' },
      { id: 3313, name: 'Fès-Meknès', code: '03' },
      ...
      { id: 3308, name: 'Kénitra', code: 'KEN' },
      { id: 3276, name: 'Khémisset', code: 'KHE' },
      { id: 3317, name: 'Khénifra', code: 'KHN' },
      { id: 3326, name: 'Khouribga', code: 'KHO' },
      { id: 3271, name: "L'Oriental", code: '02' },
      { id: 3293, name: 'Laâyoune (EH)', code: 'LAA' },
      {
        id: 3298,
      ...
      { id: 3284, name: 'Médiouna', code: 'MED' },
      { id: 4937, name: 'Meknès', code: 'MEK' },
      ...
      { id: 4927, name: 'Rabat-Salé-Kénitra', code: '04' },
      { id: 4943, name: 'Rehamna', code: 'REH' },
      { id: 3311, name: 'Safi', code: 'SAF' },
      { id: 4944, name: 'Salé', code: 'SAL' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 949, name: 'Río San Juan', code: 'SJ' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 67, name: 'Tillabéri Region', code: '6' },
  ...
  { code: 'NFK', name: 'Norfolk Island', states: [] },
  {
    ...
    states: [
      ...
      { id: 4000, name: 'South Hamgyong Province', code: '08' },
  ...
  { code: 'MNP', name: 'Northern Mariana Islands', states: [] },
  {
    ...
    states: [
      ...
      { id: 1020, name: 'Møre og Romsdal', code: '15' },
      ...
      { id: 1006, name: 'Trøndelag', code: '50' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 1397, name: 'Chiriquí Province', code: '4' },
      { id: 1387, name: 'Coclé Province', code: '2' },
      { id: 1386, name: 'Colón Province', code: '3' },
      { id: 1385, name: 'Darién Province', code: '5' },
      { id: 1396, name: 'Emberá-Wounaan Comarca', code: 'EM' },
      { id: 1388, name: 'Guna Yala', code: 'KY' },
      { id: 1389, name: 'Herrera Province', code: '6' },
      { id: 1390, name: 'Los Santos Province', code: '7' },
      { id: 1391, name: 'Ngöbe-Buglé Comarca', code: 'NB' },
      { id: 1394, name: 'Panamá Oeste Province', code: '10' },
      { id: 1395, name: 'Panamá Province', code: '8' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2784, name: 'Alto Paraná Department', code: '10' },
      { id: 2782, name: 'Amambay Department', code: '13' },
      { id: 5221, name: 'Asuncion', code: 'ASU' },
      { id: 2780, name: 'Boquerón Department', code: '19' },
      { id: 2773, name: 'Caaguazú', code: '5' },
      { id: 2775, name: 'Caazapá', code: '6' },
      { id: 2771, name: 'Canindeyú', code: '14' },
      { id: 2777, name: 'Central Department', code: '11' },
      { id: 2779, name: 'Concepción Department', code: '1' },
      { id: 2783, name: 'Cordillera Department', code: '3' },
      { id: 2772, name: 'Guairá Department', code: '4' },
      { id: 2778, name: 'Itapúa', code: '7' },
      { id: 2786, name: 'Misiones Department', code: '8' },
      { id: 2781, name: 'Ñeembucú Department', code: '12' },
      { id: 2774, name: 'Paraguarí Department', code: '9' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3680, name: 'Áncash', code: 'ANC' },
      { id: 3699, name: 'Apurímac', code: 'APU' },
      ...
      { id: 3694, name: 'San Martín', code: 'SAM' },
  ...
  { code: 'PCN', name: 'Pitcairn Island', states: [] },
  {
    ...
    states: [
      ...
      { id: 1636, name: 'Łódź Voivodeship', code: 'LD' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2238, name: 'Santarém', code: '14' },
      { id: 2242, name: 'Setúbal', code: '15' },
  ...
  { code: 'REU', name: 'Reunion', states: [] },
  {
    ...
    states: [
      ...
      { id: 4745, name: 'Dâmbovița County', code: 'DB' },
      ...
      { id: 4757, name: 'Vâlcea County', code: 'VL' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3764, name: 'Soufrière Quarter', code: '10' },
  ...
  },
  {
    ...
    states: [
      { id: 270, name: 'Príncipe Province', code: 'P' },
      { id: 271, name: 'São Tomé Province', code: 'S' },
    ],
  },
  {
    code: 'SAU',
  ...
  },
  {
    ...
    states: [
      ...
      { id: 500, name: "Grand'Anse Mahé", code: '13' },
      { id: 504, name: "Grand'Anse Praslin", code: '14' },
      { id: 495, name: 'La Digue', code: '15' },
      { id: 516, name: 'La Rivière Anglaise', code: '16' },
  ...
  { code: 'SXM', name: 'Sint Maarten (Dutch part)', states: [] },
  {
    ...
    name: 'Slovakia',
    states: [
      { id: 4352, name: 'Banská Bystrica Region', code: 'BC' },
      ...
      { id: 4358, name: 'Trenčín Region', code: 'TC' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 5096, name: 'Cádiz', code: 'CA' },
      { id: 1170, name: 'Cantabria', code: 'S' },
      { id: 5110, name: 'Castellón', code: 'CS' },
      { id: 5105, name: 'Ciudad Real', code: 'CR' },
      { id: 5097, name: 'Córdoba', code: 'CO' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 1533, name: 'Gävleborg County', code: 'X' },
      { id: 1546, name: 'Gotland County', code: 'I' },
      { id: 1548, name: 'Halland County', code: 'N' },
      { id: 5117, name: 'Jämtland County', code: '0' },
      { id: 1550, name: 'Jönköping County', code: 'F' },
      { id: 1544, name: 'Kalmar County', code: 'H' },
      { id: 1542, name: 'Kronoberg County', code: 'G' },
      { id: 1538, name: 'Norrbotten County', code: 'BD' },
      { id: 1539, name: 'Örebro County', code: 'T' },
      { id: 1536, name: 'Östergötland County', code: 'E' },
      { id: 1541, name: 'Skåne County', code: 'M' },
      { id: 1540, name: 'Södermanland County', code: 'D' },
      { id: 1551, name: 'Stockholm County', code: 'AB' },
      { id: 1545, name: 'Uppsala County', code: 'C' },
      { id: 1535, name: 'Värmland County', code: 'S' },
      { id: 1543, name: 'Västerbotten County', code: 'AC' },
      { id: 1552, name: 'Västernorrland County', code: 'Y' },
      { id: 1549, name: 'Västmanland County', code: 'U' },
      { id: 1547, name: 'Västra Götaland County', code: 'O' },
    ],
  },
  {
    code: 'CHE',
    ...
    states: [
      ...
      { id: 1660, name: 'Graubünden', code: 'GR' },
      { id: 1658, name: 'Jura', code: 'JU' },
      { id: 1663, name: 'Lucerne', code: 'LU' },
      { id: 1659, name: 'Neuchâtel', code: 'NE' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 2204, name: 'Gümüşhane', code: '29' },
      { id: 2190, name: 'Hakkâri', code: '30' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3212, name: 'Paysandú Department', code: 'PA' },
      { id: 3210, name: 'Río Negro Department', code: 'RN' },
      { id: 3207, name: 'Rivera Department', code: 'RV' },
      { id: 3216, name: 'Rocha Department', code: 'RO' },
      { id: 3220, name: 'Salto Department', code: 'SA' },
      { id: 3204, name: 'San José Department', code: 'SJ' },
      { id: 3219, name: 'Soriano Department', code: 'SO' },
      { id: 3221, name: 'Tacuarembó Department', code: 'TA' },
  ...
  },
  {
    ...
    states: [
      ...
      { id: 3770, name: 'Bà Rịa-Vũng Tàu', code: '43' },
      { id: 3815, name: 'Bắc Giang', code: '54' },
      { id: 3822, name: 'Bắc Kạn', code: '53' },
      { id: 3804, name: 'Bạc Liêu', code: '55' },
      { id: 3791, name: 'Bắc Ninh', code: '56' },
      { id: 3796, name: 'Bến Tre', code: '50' },
      { id: 3785, name: 'Bình Dương', code: '57' },
      { id: 3830, name: 'Bình Định', code: '31' },
      { id: 3797, name: 'Bình Phước', code: '58' },
      { id: 3787, name: 'Bình Thuận', code: '40' },
      { id: 3778, name: 'Cà Mau', code: '59' },
      { id: 4925, name: 'Cần Thơ', code: 'CT' },
      { id: 3782, name: 'Cao Bằng', code: '04' },
      { id: 3806, name: 'Đà Nẵng', code: 'DN' },
      { id: 3829, name: 'Đắk Lắk', code: '33' },
      { id: 3823, name: 'Đắk Nông', code: '72' },
      { id: 3773, name: 'Điện Biên', code: '71' },
      { id: 3821, name: 'Đồng Nai', code: '39' },
      { id: 3769, name: 'Đồng Tháp', code: '45' },
      { id: 3813, name: 'Gia Lai', code: '30' },
      { id: 3779, name: 'Hà Giang', code: '03' },
      { id: 3802, name: 'Hà Nam', code: '63' },
      { id: 3810, name: 'Hà Nội', code: 'HN' },
      { id: 3816, name: 'Hà Tĩnh', code: '23' },
      { id: 3827, name: 'Hải Dương', code: '61' },
      { id: 3783, name: 'Hải Phòng', code: 'HP' },
      { id: 3777, name: 'Hậu Giang', code: '73' },
      { id: 3811, name: 'Hồ Chí Minh', code: 'SG' },
      { id: 3799, name: 'Hòa Bình', code: '14' },
      { id: 3768, name: 'Hưng Yên', code: '66' },
      { id: 3793, name: 'Khánh Hòa', code: '34' },
      { id: 3800, name: 'Kiên Giang', code: '47' },
      { id: 3772, name: 'Kon Tum', code: '28' },
      { id: 3825, name: 'Lai Châu', code: '01' },
      { id: 3818, name: 'Lâm Đồng', code: '35' },
      { id: 3792, name: 'Lạng Sơn', code: '09' },
      { id: 3817, name: 'Lào Cai', code: '02' },
      { id: 3808, name: 'Long An', code: '41' },
      { id: 3789, name: 'Nam Định', code: '67' },
      { id: 3780, name: 'Nghệ An', code: '22' },
      { id: 3786, name: 'Ninh Bình', code: '18' },
      { id: 3788, name: 'Ninh Thuận', code: '36' },
      { id: 3801, name: 'Phú Thọ', code: '68' },
      { id: 3824, name: 'Phú Yên', code: '32' },
      { id: 3809, name: 'Quảng Bình', code: '24' },
      { id: 3776, name: 'Quảng Nam', code: '27' },
      { id: 3828, name: 'Quảng Ngãi', code: '29' },
      { id: 3814, name: 'Quảng Ninh', code: '13' },
      { id: 3803, name: 'Quảng Trị', code: '25' },
      { id: 3819, name: 'Sóc Trăng', code: '52' },
      { id: 3812, name: 'Sơn La', code: '05' },
      { id: 3826, name: 'Tây Ninh', code: '37' },
      { id: 3775, name: 'Thái Bình', code: '20' },
      { id: 3807, name: 'Thái Nguyên', code: '69' },
      { id: 3771, name: 'Thanh Hóa', code: '21' },
      { id: 3798, name: 'Thừa Thiên-Huế', code: '26' },
      { id: 3781, name: 'Tiền Giang', code: '46' },
      { id: 3805, name: 'Trà Vinh', code: '51' },
      { id: 3795, name: 'Tuyên Quang', code: '07' },
      { id: 3790, name: 'Vĩnh Long', code: '49' },
      { id: 3774, name: 'Vĩnh Phúc', code: '70' },
      { id: 3784, name: 'Yên Bái', code: '06' },
    ],
  },
...
export const DEFAULT_COUNTRY_CODE = 'ARG'

export const countryCodesAndName = () =>
  countryAndStates.map((c) => {
    return {
      code: c.code,
      name: c.name,
    }
...
export const statesByCountry = (country: string | undefined) => {
  if (country) {
    return countryAndStates.find((c) => c.code === country)?.states?.sort() || []
  }
  return []
}

export const citiesByCountryAndSatet = (country: string | undefined, state: string | undefined) => {
  if (country === 'ARG') {
    return argentinaCities[state as keyof typeof argentinaCities]?.sort() || []
  }
  return []
}